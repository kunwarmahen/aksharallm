...
DOC_HINTS = (
    ...
    ("aksharallm/model/rope", "docs/18-long-context.md"),
    ...
    ("aksharallm/train/resume", "docs/05-posttraining.md"),
    ...
    ("aksharallm/longctx", "docs/18-long-context.md"),
    ("aksharallm/diffusion", "docs/19-diffusion.md"),
    ...
    ("aksharallm/portal/longctx", "docs/18-long-context.md"),
    ("aksharallm/portal/diffusion", "docs/19-diffusion.md"),
